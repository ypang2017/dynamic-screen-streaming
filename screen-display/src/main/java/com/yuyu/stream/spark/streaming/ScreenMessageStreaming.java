    ...
    private static Function0<JavaStreamingContext> createContext(final Properties serverProps) {
        Function0<JavaStreamingContext> createContextFunc = new Function0<JavaStreamingContext>() {
            ...
            public JavaStreamingContext call() throws Exception {
                String brokers = serverProps.getProperty("kafka.metadata.broker.list");
                String topics = serverProps.getProperty("kafka.topic");
                String checkpointPath = serverProps.getProperty("streaming.checkpoint.path");
                ...
                JavaDStream kafkaMessageDstreamFilter = messages.filter(new Function<String, Boolean>() {
                    @Override
